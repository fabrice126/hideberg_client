...
export default class Home extends Component {
    render() {
        ...
        let elementsSectorContents = [
            <HBwebsites key={"pg_design"} country={elementsCountry.country} elements={elementsLinksWeb} sector="design" nbElementsPerPage='20' />,
            <HBwebsites key={"pg_engineer"} country={elementsCountry.country} elements={elementsLinksWeb} sector="engineer" nbElementsPerPage='20' />,
            <HBwebsites key={"pg_finance"} country={elementsCountry.country} elements={elementsLinksWeb} sector="finance" nbElementsPerPage='20' />,
            <HBwebsites key={"pg_marketing"} country={elementsCountry.country} elements={elementsLinksWeb} sector="marketing" nbElementsPerPage='20' />,
            <HBwebsites key={"pg_programs"} country={elementsCountry.country} elements={elementsLinksWeb} sector="programs" nbElementsPerPage='20' />,
            <HBwebsites key={"pg_architectures"} country={elementsCountry.country} elements={elementsLinksWeb} sector="architectures" nbElementsPerPage='20' />];
